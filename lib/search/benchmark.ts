...
export const BENCHMARKS: Benchmark[] = [
...

  {
    ...
    kind: 'exact',
    note: 'A published article must outrank a row in the taxon table for a bare common name they share, and among two articles that score identically the one the corpus points at most is the answer. Wave 39 published Italian Ryegrass, which scores exactly the same 76 on this query and won on the alphabet; the inbound-reference tiebreak in the engine is what restores perennial ryegrass, and this case is what protects it.',
  },
  {
    query: 'clover',
    types: ['crop'],
  ...
  {
    query: 'lolium multiflorum',
    titleIncludes: ['italian ryegrass'],
    types: ['crop'],
    kind: 'scientific',
    note: 'The species half of the pair the bare "ryegrass" query can no longer decide. Each ryegrass must still win its own binomial.',
  },
  ...
  /* ---- Wave 39 editorial production campaign -------------------------------
   * Forty-nine crops moved from the taxon table to published articles in one
   * wave. Each must win three things: its own title, its own accepted
   * scientific name in full, and — where readers are at least as likely to
   * type it — the trade or regional name it is actually sold under.
   *
   * The scientific-name cases use the FULL accepted name, including subspecies
   * and cultivar-group rank, because several of these crops are infraspecific
   * taxa of a species another page already holds. The bare binomial correctly
   * belongs to that other page: "triticum aestivum" is Wheat and not Spelt,
   * "brassica oleracea" is not Brussels Sprouts. Guards for those follow the
   * block, and they are the cases this wave put at risk.
   */
  {
    query: 'timothy',
    titleIncludes: ['timothy'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'phleum pratense',
    titleIncludes: ['timothy'],
    types: ['crop'],
    kind: 'scientific',
  },
  ...
  {
    query: 'tall fescue',
    titleIncludes: ['tall fescue'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'lolium arundinaceum',
    titleIncludes: ['tall fescue'],
    types: ['crop'],
    kind: 'scientific',
  },
  {
    query: 'sainfoin',
    titleIncludes: ['sainfoin'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'onobrychis viciifolia',
    titleIncludes: ['sainfoin'],
    types: ['crop'],
    kind: 'scientific',
  },
  {
    query: 'birdsfoot trefoil',
    titleIncludes: ['birdsfoot trefoil'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'lotus corniculatus',
    titleIncludes: ['birdsfoot trefoil'],
    types: ['crop'],
    kind: 'scientific',
  },
  {
    query: 'cocksfoot',
    titleIncludes: ['cocksfoot'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'dactylis glomerata',
    titleIncludes: ['cocksfoot'],
    types: ['crop'],
    kind: 'scientific',
  },
  ...
  {
    query: 'triticum aestivum subsp. spelta',
    titleIncludes: ['spelt'],
    types: ['crop'],
    kind: 'scientific',
  },
  ...
  {
    query: 'triticum turgidum subsp. dicoccum',
    titleIncludes: ['emmer'],
    types: ['crop'],
    kind: 'scientific',
  },
  {
    query: 'einkorn',
    titleIncludes: ['einkorn'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'triticum monococcum',
    titleIncludes: ['einkorn'],
    types: ['crop'],
    kind: 'scientific',
  },
  {
    query: 'foxtail millet',
    titleIncludes: ['foxtail millet'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'setaria italica',
    titleIncludes: ['foxtail millet'],
    types: ['crop'],
    kind: 'scientific',
  },
  {
    query: 'proso millet',
    titleIncludes: ['proso millet'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'panicum miliaceum',
    titleIncludes: ['proso millet'],
    types: ['crop'],
    kind: 'scientific',
  },
  {
    query: 'italian ryegrass',
    titleIncludes: ['italian ryegrass'],
    types: ['crop'],
    kind: 'exact',
  },
  ...
  {
    query: 'napier grass',
    titleIncludes: ['napier grass'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'cenchrus purpureus',
    titleIncludes: ['napier grass'],
    types: ['crop'],
    kind: 'scientific',
  },
  {
    query: 'elephant grass',
    titleIncludes: ['napier grass'],
    types: ['crop'],
    kind: 'synonym',
  },
  {
    query: 'berseem clover',
    titleIncludes: ['berseem clover'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'trifolium alexandrinum',
    titleIncludes: ['berseem clover'],
    types: ['crop'],
    kind: 'scientific',
  },
  {
    query: 'egyptian clover',
    titleIncludes: ['berseem clover'],
    types: ['crop'],
    kind: 'synonym',
  },
  {
    query: 'wild rice',
    titleIncludes: ['wild rice'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'zizania palustris',
    titleIncludes: ['wild rice'],
    types: ['crop'],
    kind: 'scientific',
  },
  {
    ...
    titleIncludes: ['brussels sprouts'],
    types: ['crop'],
    kind: 'exact',
  },
  {
  ...
  {
    query: 'chinese cabbage',
    titleIncludes: ['chinese cabbage'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'brassica rapa pekinensis group',
    titleIncludes: ['chinese cabbage'],
    types: ['crop'],
    kind: 'scientific',
  },
  ...
  {
    query: 'pak choi',
    titleIncludes: ['pak choi'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'brassica rapa chinensis group',
    titleIncludes: ['pak choi'],
    types: ['crop'],
    kind: 'scientific',
  },
  ...
  {
    query: 'daikon',
    titleIncludes: ['daikon'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'raphanus sativus longipinnatus group',
    titleIncludes: ['daikon'],
    types: ['crop'],
    kind: 'scientific',
  },
  {
    query: 'bitter gourd',
    titleIncludes: ['bitter gourd'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'momordica charantia',
    titleIncludes: ['bitter gourd'],
    types: ['crop'],
    kind: 'scientific',
  },
  ...
  {
    query: 'tomatillo',
    titleIncludes: ['tomatillo'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'physalis philadelphica',
    titleIncludes: ['tomatillo'],
    types: ['crop'],
    kind: 'scientific',
  },
  ...
  {
    query: 'water spinach',
    titleIncludes: ['water spinach'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'ipomoea aquatica',
    titleIncludes: ['water spinach'],
    types: ['crop'],
    kind: 'scientific',
  },
  ...
  {
    query: 'camelina',
    titleIncludes: ['camelina'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'camelina sativa',
    titleIncludes: ['camelina'],
    types: ['crop'],
    kind: 'scientific',
  },
  ...
  {
    query: 'niger seed',
    titleIncludes: ['niger seed'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'guizotia abyssinica',
    titleIncludes: ['niger seed'],
    types: ['crop'],
    kind: 'scientific',
  },
  ...
  {
    query: 'perilla',
    titleIncludes: ['perilla'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'perilla frutescens',
    titleIncludes: ['perilla'],
    types: ['crop'],
    kind: 'scientific',
  },
  ...
  {
    query: 'jojoba',
    titleIncludes: ['jojoba'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'simmondsia chinensis',
    titleIncludes: ['jojoba'],
    types: ['crop'],
    kind: 'scientific',
  },
  {
    query: 'jatropha',
    titleIncludes: ['jatropha'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'jatropha curcas',
    titleIncludes: ['jatropha'],
    types: ['crop'],
    kind: 'scientific',
  },
  ...
  {
    query: 'asian pear',
    titleIncludes: ['asian pear'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'pyrus pyrifolia',
    titleIncludes: ['asian pear'],
    types: ['crop'],
    kind: 'scientific',
  },
  ...
  {
    query: 'durian',
    titleIncludes: ['durian'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'durio zibethinus',
    titleIncludes: ['durian'],
    types: ['crop'],
    kind: 'scientific',
  },
  {
    query: 'lowbush blueberry',
    titleIncludes: ['lowbush blueberry'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'vaccinium angustifolium',
    titleIncludes: ['lowbush blueberry'],
    types: ['crop'],
    kind: 'scientific',
  },
  {
    query: 'wild blueberry',
    titleIncludes: ['lowbush blueberry'],
    types: ['crop'],
    kind: 'synonym',
  },
  {
    query: 'sea buckthorn',
    titleIncludes: ['sea buckthorn'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'hippophae rhamnoides',
    titleIncludes: ['sea buckthorn'],
    types: ['crop'],
    kind: 'scientific',
  },
  ...
  {
    query: 'quince',
    titleIncludes: ['quince'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'cydonia oblonga',
    titleIncludes: ['quince'],
    types: ['crop'],
    kind: 'scientific',
  },
  ...
  {
    query: 'fenugreek',
    titleIncludes: ['fenugreek'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'trigonella foenum-graecum',
    titleIncludes: ['fenugreek'],
    types: ['crop'],
    kind: 'scientific',
  },
  ...
  {
    query: 'wasabi',
    titleIncludes: ['wasabi'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'eutrema japonicum',
    titleIncludes: ['wasabi'],
    types: ['crop'],
    kind: 'scientific',
  },
  ...
  {
    query: 'lima bean',
    titleIncludes: ['lima bean'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'phaseolus lunatus',
    titleIncludes: ['lima bean'],
    types: ['crop'],
    kind: 'scientific',
  },
  ...
  {
    query: 'winged bean',
    titleIncludes: ['winged bean'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'psophocarpus tetragonolobus',
    titleIncludes: ['winged bean'],
    types: ['crop'],
    kind: 'scientific',
  },
  ...
  {
    query: 'jerusalem artichoke',
    titleIncludes: ['jerusalem artichoke'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'helianthus tuberosus',
    titleIncludes: ['jerusalem artichoke'],
    types: ['crop'],
    kind: 'scientific',
  },
  ...
  {
    query: 'brazil nut',
    titleIncludes: ['brazil nut'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'bertholletia excelsa',
    titleIncludes: ['brazil nut'],
    types: ['crop'],
    kind: 'scientific',
  },
  ...
  {
    query: 'stevia',
    titleIncludes: ['stevia'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'stevia rebaudiana',
    titleIncludes: ['stevia'],
    types: ['crop'],
    kind: 'scientific',
  },
  ...
  {
    query: 'yerba mate',
    titleIncludes: ['yerba mate'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'ilex paraguariensis',
    titleIncludes: ['yerba mate'],
    types: ['crop'],
    kind: 'scientific',
  },
  ...
  /* Guards the wave put at risk: a bare species binomial must not be captured
   * by the infraspecific taxon this wave published under it. */
  {
    query: 'triticum aestivum',
    mustNotTop: ['spelt'],
    types: ['crop'],
    kind: 'scientific',
    note: 'Spelt is Triticum aestivum subsp. spelta and carries every token of the species name. Publishing it must not take the species name from wheat.',
  },
  {
    query: 'brassica oleracea',
    mustNotTop: ['brussels'],
    kind: 'scientific',
    note: 'Brussels sprouts is a cultivar group of B. oleracea, one of six crops in this corpus that are. No single one may claim the species name.',
  },
  {
    query: 'lolium perenne',
    titleIncludes: ['perennial ryegrass'],
    ...
    mustNotTop: ['italian'],
    kind: 'scientific',
    note: 'Publishing Italian ryegrass must not cost perennial ryegrass its own binomial.',
  },
  {
    query: 'cherry',
    titleIncludes: ['cherry'],
    mustNotTop: ['sour'],
    types: ['crop'],
    kind: 'exact',
    note: 'Sour cherry is a separate species. A bare "cherry" is the sweet cherry page, which is what the corpus held before this wave.',
  },
  {
    query: 'blueberry',
    titleIncludes: ['blueberry'],
    mustNotTop: ['lowbush'],
    types: ['crop'],
    kind: 'exact',
    note: 'Lowbush blueberry is a different species and a different production system; it must not take the bare name from highbush blueberry.',
  },
  {
    query: 'pear',
    titleIncludes: ['pear'],
    ...
    types: ['crop'],
    kind: 'exact',
    note: 'Asian pear is a separate species with a separate market.',
  },
  {
    query: 'tart cherry',
    titleIncludes: ['sour cherry'],
   ...
   * Twenty-nine crops selected against a measured composition audit rather than
   * from a queue: tropical forages, African indigenous vegetables and roots,
   * South Asian minor cereals and pulses, Andean tubers, underused fibres.
   *
   * Each asserts its own title and its own accepted scientific name, and — for
   * the crops whose regional name is what a reader will actually type — that
   * name too. The guards after the block are the ambiguities the wave created:
   * two crops now answer to "African eggplant" and two to "cocoyam", and the
   * corpus asserts no species for either.
   */
  {
    query: 'signal grass',
    titleIncludes: ['signal grass'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'urochloa brizantha',
    titleIncludes: ['signal grass'],
    types: ['crop'],
    kind: 'scientific',
  },
  {
    query: 'palisade grass',
    titleIncludes: ['signal grass'],
    types: ['crop'],
    kind: 'synonym',
  },
  ...
  {
    query: 'guinea grass',
    titleIncludes: ['guinea grass'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'megathyrsus maximus',
    titleIncludes: ['guinea grass'],
    types: ['crop'],
    kind: 'scientific',
  },
  {
    query: 'panicum maximum',
    titleIncludes: ['guinea grass'],
    types: ['crop'],
    kind: 'synonym',
  },
  {
    query: 'rhodes grass',
    titleIncludes: ['rhodes grass'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'chloris gayana',
    titleIncludes: ['rhodes grass'],
    types: ['crop'],
    kind: 'scientific',
  },
  ...
  {
    query: 'stylosanthes guianensis',
    titleIncludes: ['stylo'],
    types: ['crop'],
    kind: 'scientific',
  },
  {
    query: 'greenleaf desmodium',
    titleIncludes: ['greenleaf desmodium'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'desmodium intortum',
    titleIncludes: ['greenleaf desmodium'],
    types: ['crop'],
    kind: 'scientific',
  },
  {
    query: 'scarlet eggplant',
    titleIncludes: ['scarlet eggplant'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'solanum aethiopicum',
    titleIncludes: ['scarlet eggplant'],
    types: ['crop'],
    kind: 'scientific',
  },
  {
    query: 'gboma eggplant',
    titleIncludes: ['gboma eggplant'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'solanum macrocarpon',
    titleIncludes: ['gboma eggplant'],
    types: ['crop'],
    kind: 'scientific',
  },
  {
    query: 'waterleaf',
    titleIncludes: ['waterleaf'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'talinum fruticosum',
    titleIncludes: ['waterleaf'],
    types: ['crop'],
    kind: 'scientific',
  },
  {
    query: 'tannia',
    titleIncludes: ['tannia'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'xanthosoma sagittifolium',
    titleIncludes: ['tannia'],
    types: ['crop'],
    kind: 'scientific',
  },
  ...
  {
    query: 'hausa potato',
    titleIncludes: ['hausa potato'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'coleus rotundifolius',
    titleIncludes: ['hausa potato'],
    types: ['crop'],
    kind: 'scientific',
  },
  ...
  {
    query: 'barnyard millet',
    titleIncludes: ['barnyard millet'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'echinochloa frumentacea',
    titleIncludes: ['barnyard millet'],
    types: ['crop'],
    kind: 'scientific',
  },
  {
    query: 'kodo millet',
    titleIncludes: ['kodo millet'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'paspalum scrobiculatum',
    titleIncludes: ['kodo millet'],
    types: ['crop'],
    kind: 'scientific',
  },
  {
    query: 'horse gram',
    titleIncludes: ['horse gram'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'macrotyloma uniflorum',
    titleIncludes: ['horse gram'],
    types: ['crop'],
    kind: 'scientific',
  },
  ...
  {
    query: 'moth bean',
    titleIncludes: ['moth bean'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'vigna aconitifolia',
    titleIncludes: ['moth bean'],
    types: ['crop'],
    kind: 'scientific',
  },
  ...
  {
    query: "job's tears",
    titleIncludes: ["job's tears"],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'coix lacryma-jobi',
    titleIncludes: ["job's tears"],
    types: ['crop'],
    kind: 'scientific',
  },
  ...
  {
    query: 'ceiba pentandra',
    titleIncludes: ['kapok'],
    types: ['crop'],
    kind: 'scientific',
  },
  {
    query: 'silk cotton tree',
    titleIncludes: ['kapok'],
    types: ['crop'],
    kind: 'synonym',
  },
  {
    query: 'ulluco',
    titleIncludes: ['ulluco'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'ullucus tuberosus',
    titleIncludes: ['ulluco'],
    types: ['crop'],
    kind: 'scientific',
  },
  ...
  {
    query: 'mashua',
    titleIncludes: ['mashua'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'tropaeolum tuberosum',
    titleIncludes: ['mashua'],
    types: ['crop'],
    kind: 'scientific',
  },
  ...
  {
    query: 'velvet bean',
    titleIncludes: ['velvet bean'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'mucuna pruriens',
    titleIncludes: ['velvet bean'],
    types: ['crop'],
    kind: 'scientific',
  },
  ...
  {
    query: 'jack bean',
    titleIncludes: ['jack bean'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'canavalia ensiformis',
    titleIncludes: ['jack bean'],
    types: ['crop'],
    kind: 'scientific',
  },
  {
    query: 'rice bean',
    titleIncludes: ['rice bean'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'vigna umbellata',
    titleIncludes: ['rice bean'],
    types: ['crop'],
    kind: 'scientific',
  },
  ...
  {
    query: 'jicama',
    titleIncludes: ['jicama'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'pachyrhizus erosus',
    titleIncludes: ['jicama'],
    types: ['crop'],
    kind: 'scientific',
  },
  ...
  {
    query: 'mangosteen',
    titleIncludes: ['mangosteen'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'garcinia mangostana',
    titleIncludes: ['mangosteen'],
    types: ['crop'],
    kind: 'scientific',
  },
  {
    query: 'cape gooseberry',
    titleIncludes: ['cape gooseberry'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'physalis peruviana',
    titleIncludes: ['cape gooseberry'],
    types: ['crop'],
    kind: 'scientific',
  },
  ...
  {
    query: 'black cumin',
    titleIncludes: ['black cumin'],
    types: ['crop'],
    kind: 'exact',
  },
  {
    query: 'nigella sativa',
    titleIncludes: ['black cumin'],
    types: ['crop'],
    kind: 'scientific',
  },
  ...
  /* Ambiguities this wave created. No species is asserted for either, for the
   * same reason the "clover" case asserts none: two published crops carry the
   * name and choosing one would assert a false equivalence. */
  {
    query: 'african eggplant',
    types: ['crop'],
    mustNotTopTypes: ['crop-taxon'],
    kind: 'exact',
    note: 'Scarlet eggplant and gboma eggplant are both called African eggplant and both are now published. The guard is that the answer is an article a reader can open.',
  },
  {
    query: 'cocoyam',
    types: ['crop'],
    mustNotTopTypes: ['crop-taxon'],
    kind: 'exact',
    note: 'Taro and tannia are both cocoyam, in different genera from different continents. Publishing tannia must not make the name resolve arbitrarily.',
  },
  {
    query: 'taro',
    titleIncludes: ['taro'],
    ...
    mustNotTop: ['tannia'],
    kind: 'exact',
    note: 'Publishing tannia must not cost taro its own name.',
  },
  {
    query: 'cowpea',
    titleIncludes: ['cowpea'],
    types: ['crop'],
    mustNotTop: ['yardlong'],
    kind: 'exact',
    note: 'Yardlong bean is a subspecies of cowpea and carries every token of the species name; it must not take it.',
  },
  {
    query: 'cumin',
    titleIncludes: ['cumin'],
    ...
    mustNotTop: ['black'],
    kind: 'exact',
    note: 'Black cumin is an unrelated Ranunculaceae. A bare "cumin" is Cuminum cyminum.',
  },

  /* ---- Wave 41 umbrella concepts and their children -------------------------
   * The scope reviews are only worth something if the search reflects them. A
   * bare umbrella term must return the concept page — and must NOT be taken by
   * a child, which is the failure mode publishing a child creates. A specific
   * term must return the child, which is the failure mode declaring an umbrella
   * creates. Both directions are asserted for every concept that has a child a
   * reader is likely to type.
   */
  {
    query: 'coffee',
    titleIncludes: ['coffee'],
    ...
    mustNotTop: ['arabica'],
    kind: 'exact',
    note: 'An umbrella term must return the concept page, not one of the plants under it.',
  },
  {
    query: 'cotton',
    titleIncludes: ['cotton'],
  ...
  {
    query: 'pumpkin',
    titleIncludes: ['pumpkin'],
    types: ['crop'],
    mustNotTop: ['butternut'],
    kind: 'exact',
    note: 'An umbrella term must return the concept page, not one of the plants under it.',
  },
  {
    query: 'banana',
    titleIncludes: ['banana'],
    types: ['crop'],
    mustNotTop: ['plantain'],
    kind: 'exact',
    note: 'An umbrella term must return the concept page, not one of the plants under it.',
  ...
  {
    query: 'mustard',
    titleIncludes: ['mustard'],
    types: ['crop'],
    mustNotTop: ['ethiopian'],
    kind: 'exact',
    note: 'An umbrella term must return the concept page, not one of the plants under it.',
  },
  {
  ...
  {
    query: 'mulberry',
    titleIncludes: ['mulberry'],
    types: ['crop'],
    mustNotTop: ['black mulberry'],
    kind: 'exact',
    note: 'An umbrella term must return the concept page, not one of the plants under it.',
  },
  {
