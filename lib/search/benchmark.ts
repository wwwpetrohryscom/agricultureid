...
export const BENCHMARKS: Benchmark[] = [
  ...
  },
  {
    ...
    kind: 'synonym',
    knownIssue:
      'Returns sweet Cherry. "Tart cherry" is the North American trade name for Prunus cerasus and sour cherry holds it as an alternative name, so the whole-name bonus applies — but Cherry matches "cherry" across title, names, scientific name, category, summary and relation labels, and that raw field score dwarfs any fixed bonus. Raising the name bonus to title strength was tried in Wave 39: it did not fix this case and it broke "reefer container", so it was reverted. The fix is a field-frequency normalisation, which is a search-model change.',
  },
];
