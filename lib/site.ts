...
export const CONTENT_TYPE_ROUTE: Record<ContentType, string> = {
  ...
  'post-harvest-defect': 'post-harvest-defects',
  'quality-measurement': 'quality-measurements',
...
export const SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    href: '/processing',
    description:
      'Primary processing methods that transform a harvested commodity into products, co-products, and by-products.',
    active: true,
  ...
  },
  {
    ...
    description:
      'Measurable properties of a harvested lot — what each one tells you, and what it does not.',
    active: true,
    contentType: 'quality-attribute',
  },
  {
    label: 'Post-Harvest Defects',
    href: '/post-harvest-defects',
    description:
      'How harvested produce deteriorates or fails — causes, confusable disorders, and the limits of visual diagnosis.',
    active: true,
    contentType: 'post-harvest-defect',
  },
  {
    label: 'Quality Measurements',
    href: '/quality-measurements',
    description:
      'Methods and instruments used to measure post-harvest quality attributes, and where each is unreliable.',
    active: true,
