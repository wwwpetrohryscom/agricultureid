...
export const LAYER_ASSESSMENTS: readonly LayerEvidenceAssessment[] = [
  ...
  },
  {
    ...
    reason: 'SOURCE_EXISTS_NOT_MAPPED',
    finding:
      'Registrations reach crops only through published cultivars, and the corpus holds 77 cultivars against 165 crops. The registers themselves cover far more species than that. The constraint is deliberate: Waves 7 to 10 established that 51 per cent of exact name matches between a register and a cultivar were cross-species homonyms — a wheat denomination matching a strawberry PBR — so matching is fail-closed on name AND species together.',
    wouldRaiseCoverageBy:
  ...
  {
    layer: 'climate',
    reachesAtAssessment: 156,
    reason: 'NOT_RESEARCHED',
    finding:
      'Nine published crops name no climate reference. Whether those nine are genuinely unrelated to any of the 20 climate concept pages, or simply have not had the reference added, has not been examined.',
    wouldRaiseCoverageBy:
